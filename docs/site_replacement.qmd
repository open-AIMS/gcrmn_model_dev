...
- **Use of covariates**: whilst other covariates (such as sea surface
  ...
  - Inclusion of the previous years cover estimate in a model (which
    ...
    proportionally bigger issue with shorter the time series.
  - Inclusion of multiple lagged versions of each of the covariates
    that are likely to represent causal disturbances.

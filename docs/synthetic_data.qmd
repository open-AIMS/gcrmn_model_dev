...
| dataset 14 | All Western reefs                                             |
| dataset 15 | All Eastern reefs                                             |
| dataset 16 | 25 Western reefs, each with 2 sites and 5 transects per site  |
| dataset 17 | 2 E reefs, each with 2 sites and 5 transects per site         |
...
| dataset 16   | dataset 14 |
| dataset 17   | dataset 15 |
...
```{r}
#| label: synthetic landscape benthos reefs western
#| results: markup
#| eval: true
#| echo: true
#| cache: false
```
```{r}
#| label: synthetic landscape benthos reefs western plot
#| results: markup
#| eval: true
#| echo: true
#| cache: false
#| fig-width: 8
#| fig-height: 6
benthos_reefs_pts_western <- readRDS(
  file = paste0(data_path, "synthetic/benthos_reefs_pts_western.rds")
)
...
```{r}
#| label: synthetic landscape benthos reefs western sampled
#| results: markup
#| eval: true
#| echo: true
#| cache: false
...
```{r}
#| label: synthetic landscape benthos reefs western sampled plot
#| results: markup
#| eval: true
#| echo: true
#| cache: false
...
bbox_split <-
  ...
  st_collection_extract("POLYGON") |>
  st_as_sf() |>
  mutate(xpos = st_coordinates(st_centroid(x))[,"X"]) |> 
  mutate(Half = ifelse(xpos == max(xpos), "Eastern", "Western"))

benthos_fixed_locs_western_sf <- readRDS(
  file = paste0(data_path, "synthetic/benthos_fixed_locs_western_sf.rds")
)
bbox_split |> st_intersection(spatial_domain) |>
  filter(Half == "Western") |> 
  ggplot() +
  geom_sf() +
  geom_sf(data = benthos_fixed_locs_western_sf,
    aes(fill = plogis(HCC), color = plogis(HCC))) +
  facet_wrap(~Year) +
  scale_fill_viridis_c() +
  scale_color_viridis_c() +
...
```{r}
#| label: synthetic landscape benthos reefs eastern
#| results: markup
#| eval: true
#| echo: true
#| cache: false
```
```{r}
#| label: synthetic landscape benthos reefs eastern plot
#| results: markup
#| eval: true
#| echo: true
#| cache: false
#| fig-width: 8
#| fig-height: 6
benthos_reefs_pts_eastern <- readRDS(
  file = paste0(data_path, "synthetic/benthos_reefs_pts_eastern.rds")
)
...
```{r}
#| label: synthetic landscape benthos reefs eastern sampled
#| results: markup
#| eval: true
#| echo: true
#| cache: false
...
```{r}
#| label: synthetic landscape benthos reefs eastern sampled plot
#| results: markup
#| eval: true
#| echo: true
#| cache: false
...
benthos_fixed_locs_eastern_sf <- readRDS(
  file = paste0(data_path, "synthetic/benthos_fixed_locs_eastern_sf.rds")
)
bbox_split |> st_intersection(spatial_domain) |>
  filter(Half == "Eastern") |> 
  ggplot() +
  geom_sf() +
  geom_sf(data = benthos_fixed_locs_eastern_sf,
    aes(fill = plogis(HCC), color = plogis(HCC))) +
  facet_wrap(~Year) +
  scale_fill_viridis_c() +
  scale_color_viridis_c() +
